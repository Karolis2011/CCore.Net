...
namespace ChakraCore.Net.JsRt
{
    ...
    public delegate void JsHostPromiseRejectionTrackerCallback(JsValueRef promise, JsValueRef reason, [MarshalAs(UnmanagedType.U1)] bool handled, IntPtr callbackState);
