...
namespace CCore.Net.JsRt
{
    ...
    /// </returns>
    public delegate JsErrorCode JsFetchImportedModuleFromScriptCallBack(JsSourceContext dwReferencingSourceContext, JsValueRef specifier, out JsModule? dependentModuleRecord);
}